...
if __name__ == "__main__":
    ...
    (train_data, eval_data, test_data, ood_test_data) = load_dataset(train_hyperparameters['dataset_name'])
    ...
    accuracy_ood = evaluate(model, ood_test_data, config["training"]["loss_function"], device=device)

    print(f"Accuracy on OOD test set: {accuracy_ood}")
